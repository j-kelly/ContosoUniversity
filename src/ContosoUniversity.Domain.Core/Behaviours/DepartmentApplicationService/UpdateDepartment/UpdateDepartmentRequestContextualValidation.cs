namespace ContosoUniversity.Domain.Core.Behaviours.DepartmentApplicationService.UpdateDepartment
{
    ...
    public class UpdateDepartmentRequestContextualValidation : ContextualValidation<UpdateDepartmentRequest, UpdateDepartmentCommandModel>
    {
        public UpdateDepartmentRequestContextualValidation(UpdateDepartmentRequest context)
            : base(context)
        {
        }
