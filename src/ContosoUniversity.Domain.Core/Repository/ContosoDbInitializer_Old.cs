...
//    using System.Linq;
//    public class ContosoDbInitializer_Old : DropCreateDatabaseIfModelChanges<ContosoDbContext>
//    {
...
//            var department = new Department { DepartmentID = 1, Name = "MainDepartment", StartDate = DateTime.Parse("2000-01-01"), CreatedBy = "Anon", ModifiedBy = "Anon", CreatedOn = DateTimeHelper.Now, ModifiedOn = DateTimeHelper.Now };
